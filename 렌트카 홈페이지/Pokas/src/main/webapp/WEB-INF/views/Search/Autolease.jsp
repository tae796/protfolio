...
<head>
    ...
    <title>오토리스</title>
    <link rel="stylesheet" href="../../resources/css/autolease.css">
    ...
    <script src="../../resources/js/autolease.js"></script>
     <script>
function deletefunc(id) {
    ...
    $(function() {
		...
		var brand = "";
		 ...
		 console.log(getParameterByName('brand'));
		 console.log(getParameterByName('oil_type'));
		 console.log(getParameterByName('car_type'));
    	...
    	$("#search_btn").click(function() {
        	...
        	window.location.href="/Search/Autolease?capge=1&brand="+brand+"&car_type="+car_type+"&oil_type="+oil_type+"#target";
	...
	<div id="target"></div>
        ...
        <section id="all">
            ...
            <div class="cont">
                ...
                <!-- <div class="img_all">
                   <c:forEach var="auto" items="${list}" begin="0" end="7"> 
                <div class="right_part">
                    <div class="img">
						<img src="/resources/img/${auto.image}" style="width: 100%; height: 100%;">
                    </div>
                    <div class="text">
                        <h3><c:out value="${auto.brand}"/> <c:out value="${auto.name}"/></h3>
                        <p><fmt:formatNumber value="${auto.price}" pattern="#,###" /><span> 원</span></p>
                        <h4><c:out value="${auto.size}"/> <c:out value="${auto.oil_type}"/> 연비 <c:out value="${auto.oil_rate}"/>km/l</h4>
                    </div>
                    <button><a href="/Request/Ask?type=2&car_type=${auto.size}">신청하기</a></button>
                </div>  
                </c:forEach>
                </div> -->
                <!---->
...
<div class="box">
    ...
    height:auto;
">
                	<img src="../../resources/img/${auto.image}" style="
    width: 100%;
    height:auto;
...
">
                ...
                <div class="middle">
                    <table>
                        <tr>
                            ...
                            </td><td>연료</td><td><c:out value="${auto.oil_type}"/></td>
                        </tr>
                        <tr>
                            <td>연비</td><td><c:out value="${auto.oil_rate}"/>km/l</td>
                             <td>브랜드</td><td><c:out value="${auto.brand}"/></td>
                        </tr>
                        <tr>
                            <td>사이즈</td><td><c:out value="${auto.size}"/></td>
                            <td>초기비용</td><td><c:out value="${auto.initcost}"/>원</td>
                        </tr>
                    </table>
                </div>
                <div class="bottom">
                    <div class="money">
                        <span><fmt:formatNumber value="${auto.price}" pattern="#,###" />원</span>
                    </div>
                    <button><a href="/Request/Ask?type=1&car_type=${auto.name}#target">
                        <h2>고객맞춤</h2>
                        <h2>상담신청</h2>
                    </a></button>
                </div>
			...
			<div class="write_button">
				<button onclick="updatefunc(${auto.id});" class="write">수정</button>
            	<button onclick="deletefunc(${auto.id});" class="write">삭제</button>
            </div>
		</c:when>
		<c:otherwise>
		</c:otherwise>
