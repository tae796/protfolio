...
<!-- <section id="side-wrap">
    ...
    <section id="table">
    <form action ="/Search/Car_updateProc" enctype="multipart/form-data" method="post" accept-charset="UTF-8">
        <div class="cont">
			<table>
				<tbody>
					...
					<tr>
						...
						<td class="table_cont cont_04">
							...
							<input class="write-input" type='text' value="${view.name}" name='name' id="name" style="margin-left: 0px;" />
					...
					<tr>
						...
						<td class="table_cont cont_04">
							...
							<input class="write-input" value="${view.size}" type='text' name='size' />
					...
					<tr>
						...
						<td class="table_cont cont_04">
							...
							<select name="brand" class="write-input" required>
								<option value="${view.brand}">${view.brand}</option>
					...
					<tr>
						...
						<td class="table_cont cont_05">
							...
							<input class="write-input" type='num' value="${view.price}" name='price' />
					...
					<tr>
						...
						<td class="table_cont cont_05">
							...
							<input class="write-input" type='num' value="${view.initcost}" name='initcost' />
					...
					<tr>
						...
						<td class="table_cont cont_05 filup-box">
							...
							<input class="file-input" type="file" name="files" value="${view.image}" id="image" accept=".jpg">
