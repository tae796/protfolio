...
<section id="side-wrap">
 ...
 <header id="header">
    ...
    <section id="method">
        <div class="cont">
            <div class="title">
                <h3 class="a"><span class="a">새차</span>를 갖는 가장 합리적인 방법!</h3>
                <p class="a">차종,브랜드,유종에 상관없는</p>
                <p class="a">자유로운 선택!</p>
                <p class="a">갖고싶던 내 차의 견적을 확인해보세요!</p>
            </div>
            <div class="icon">
                <div class="icon_img">
                    <div class="img"></div>
    ...
    <section id="nonstop">
        <div class="bg">
            <div class="cont">
                <div class="cont_line">
                    <div class="title">
                        <h2 class="a">오토리스 & 장기렌트</h2>
                        <h1 class="a">논스톱 업무처리</h1>
                    </div>
                    <div class="icon">
