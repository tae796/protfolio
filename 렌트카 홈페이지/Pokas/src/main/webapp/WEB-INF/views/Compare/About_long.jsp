...
<head>
    ...
    <title>장기렌트란?</title>
    <link rel="stylesheet" href="../../resources/css/about_long.css">
    ...
    $(function() {
    	$("#link_button").click(function() {
    		window.location.href="/Search/Long_term?cpage=1";
    	});
...
<section id="side-wrap">
 ...
 <header id="header">
    ...
    <section id="about">
		<section id="title">
			<div class="cont pc">
				<h3 class="a">장기렌트를 찾으신다면 <span class="a">스마일 장기렌트카로!</span></h3>
				<p class="a">" 운행거리가 많거나 업무용으로 이용하는 고객님이시라면, <br>
				가장 효율적인 구입방법으로 장기렌트를 선택하세요. "</p>
			</div>
			<div class="cont mobile">
				<h3 class="a">장기렌트를 찾으신다면 <br> <span class="a">스마일 장기렌트카로!</span></h3>
				<p class="a">" 운행거리가 많거나 업무용으로 이용하는 고객님이시라면, 
				가장 효율적인 구입방법으로 장기렌트를 선택하세요. "</p>
			</div>
		</section> 
        <div class="bg">
    ...
    <section id="button">
        <div class="cont">
            <button onclick="location.href='/Request/Ask?type=0#target';" class="a">장기렌트 최저가 확인하기</button>
        </div>
    </section>
	</section>
	<footer>
