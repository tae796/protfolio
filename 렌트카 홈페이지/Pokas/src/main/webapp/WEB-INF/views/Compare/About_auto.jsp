...
<head>
    ...
    <title>오토리스란?</title>
    <link rel="stylesheet" href="../../resources/css/about_auto.css">
    ...
    $(function() {
    	$("#link_button").click(function() {
    		window.location.href="/Search/Autolease?cpage=1";
    	});
...
<section id="side-wrap">
    ...
    <section id="about">
		<section id="title">
         <div class="cont pc">
            <h3 class="a">오토리스를 찾으신다면 <span class="a">스마일 장기렌트카로!</span></h3>
            <p class="a">" 비용처리가 간편하고 품위를 유지 할 수 있습니다. <br> 전문직 고소득 직종분이시면 매우 유리합니다. "</p>
         </div>
         <div class="cont mobile">
            <h3 class="a">오토리스를 찾으신다면 <br> <span class="a">스마일 장기렌트카로!</span></h3>
            <p class="a">" 비용처리가 간편하고 품위를 유지 할 수 있습니다. 전문직 고소득 직종분이시면 매우 유리합니다. "</p>
         </div>
      </section>
        <div class="bg">
            <div class="cont">
    ...
    <section id="button">
        <div class="cont">
            <button onclick="location.href='/Request/Ask?type=1#target';" class="a">오토리스 최저가 확인하기</button>
        </div>
    </section>
    </section>
