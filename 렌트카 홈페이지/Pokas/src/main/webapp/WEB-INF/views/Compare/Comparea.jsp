...
<head>
    ...
    $(function() {
    	$("#link_button").click(function() {
    		window.location.href="/Request/Ask";
    	});
...
<section id="side-wrap">
 ...
 <header id="header">
    ...
    <section id="main">
        <div class="bg">
            <div class="title">
                <h3 class="a">장기렌트 VS 오토리스</h3>
                <p>LONG TERM RENTAL VS AUTOLEASE</p>
            </div>
        </div>
    </section>
    ...
    <section id="table">
        <div class="cont">
            <table>
                <thead>
                    <tr>
                        <td>장기렌트</td><td>vs</td><td>오토리스</td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>LPG 포함 전 차종(화물차 제외)</td><td>이용차종</td><td>렌터카 전용 LPG차량 외 전 차종</td>
                    </tr>
                    <tr>
                        <td>렌터카 전용 번호판(호,하)</td><td>번호판</td><td>일반 번호판</td>
                    </tr>
                    <tr>
                        <td>차량,취/등록비용 자동차세, 보험료 <br>
                            (정비포함 선택가능)</td><td>이용료
                                포함내역</td><td>차량,취/등록비용<br>
                                (자동차세, 보험료, 정비포함 선택가능)</td>
                    </tr>
                    <tr>
                        <td>렌터카 업체 (보험경력 단절)</td><td>보험가입자</td><td>리스 이용자 (보험경력 유지)</td>
                    </tr>
                    <tr>
                        <td>연간 10,000km~ 무제한</td><td>약정 운행거리</td><td>연간 20,000km~ 40,000km <br>
                            (초과시 추가비용 발생)</td>
                    </tr>
                    <tr>
                        <td>정기관리 (선택가능)</td><td>차량정비</td><td>선택사항</td>
                    </tr>
                    <tr>
                        <td>가능 (전자 세금 계산서 발급)</td><td>비용처리</td><td>가능</td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <section id="mobile_compare">
        <div class="cont">
            <table>
                <thead>
                    <tr>
                        <td>vs</td><td>오토리스 <span>금융회사 명의로 구입</span></td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>이용차종</td><td>렌터카 전용 LPG차량 외 전 차종</td>
                    </tr>
                    <tr>
                        <td>번호판</td><td>일반 번호판</td>
                    </tr>
                    <tr>
                        <td>이용료포함내역</td><td>차량,취/등록비용<br>
                        (자동차세, 보험료, 정비포함 선택가능)</td>
                    </tr>
                    <tr>
                        <td>보험가입자</td><td>리스 이용자 (보험경력 단절)</td>
                    </tr>
                    <tr>
                        <td>약정 운행거리</td><td>연간 20,000km~ 40,000km <br>
                            (초과시 추가비용 발생)</td>
                    </tr>
                    <tr>
                        <td>차량정비</td><td>선택사항</td>
                    </tr>
                    <tr>
                        <td>비용처리</td><td>가능</td>
                    </tr>
    ...
    <section id="bottom">
        <div class="bg">
            <div class="cont">
                <div class="title">
                    <h1 class="a">내가 원하는 차량!</h1>
                    <h1 class="a">빠르게 상담해드립니다.</h1>
                </div>
                <button onclick="location.href='/Request/Ask';" class="a">상담하기</button>
            </div>
        </div>
    </section>
