...
<head>
    ...
    <title>회사소개</title>
    <link rel="stylesheet" href="../../resources/css/partnership.css">
...
<section id="side-wrap">
 ...
 <header id="header">
	...
	<section id="table">
	 <form action ="/Company/PartnershipProc" enctype="multipart/form=data" method="post" accept-charset="UTF-8">
		<div class="cont">
			<table>
				<tbody>
					<tr>
						<td class="name">업체명</td>
						<td class="table_cont cont_01">
							<input type="text">
						</td>
					</tr>
					   <tr>
                        <td class="name">휴대폰</td><td class="table_cont cont_04">
                    ...
                    <tr>
                        <td class="name">이메일</td><td class="table_cont cont_04">
					...
					<tr>
						<td class="name">제휴제목</td>
						<td class="table_cont cont_04">
							<input type="text" name='title'>
						</td>
					</tr>
					<tr>
						<td class="name">제휴문의</td>
