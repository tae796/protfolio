...
<section id="side-wrap">
 ...
 <header id="header">
    ...
    <section id="title">
            <h3>스마일장기렌트카에서는 <span>신입 및 경력 영업사원을</span></h3>
            <h3>상시 채용하고 있습니다.</h3>
    </section>
    ...
    <section id="img">
        <div class="cont">
            <div class="title">
                <div class="logo"></div>
                <h3>스마일장기렌트카에서 <span>일하면 좋은 점</span></h3>
            </div>
            <div class="cont_part">
                <ul>
                    <li>
    ...
    <section id="last">
        <div class="title">
            <h1>저희 주)스마일장기렌트카를 믿어주셔서 감사합니다.</h1>

            <h1>대표번호로 전화 주셔서 &ldquo;입사 지원 하겠습니다&rdquo;라고 해주시면 미팅일정 잡고 방문하셔서 면담하고 </h1> 
                
            <h1>모든 역량을 총 동원해서 영업할 수 있게 지원하겠습니다. </h1>
