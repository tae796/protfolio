	...
	<section id="table">
      ...
      <c:when test="${not empty mdto}">
		<div class="cont">
				...
				<tbody>
					...
					<tr>
						...
						<td class="table_cont cont_04">
							<input class="write-input" type='text' id="type" name='type' value="${view.type}" readonly/>
						</td>
						<td class="name">차종</td>
						<td class="table_cont cont_04">

							<input class="write-input" type='text' id="car_type" name='title' value="${view.car_type}" readonly/>
					...
					<tr>
						...
						<td class="table_cont cont_04">
							...
							<input class="write-input" type='text' id="name" name='writer' value="${view.name}" readonly/>
					...
					<tr>
						...
						<td class="table_cont cont_04" colspan="4">
							...
							<textarea  id="autotext" cols="100" rows="10" wrap="on">${view.detail}</textarea>
			...
			<div class="btn-wrap">
					<button type="button" id="updatebtn" class="btn_a"><h4 class="a">수정</h4></button>
