...
<head>
    ...
    <title>견적문의</title>
    <link rel="stylesheet" href="../../resources/css/ask_done.css">
...
<script type="text/javascript">
      kakaoPixel('7357371967305106267').pageView();
      kakaoPixel('7357371967305106267').signUp('SignUp');
</script>
    <script>
    $(function() {
...
<!-- <section id="side-wrap">
    ...
    <section id="finish">
        <div class="cont">
            <div class="text">
                <h1>견적신청이 완료되었습니다. <br> 조금만 기다려 주시면 <br>
					"전문 카플래너" 가 연락드립니다^^</h1>
