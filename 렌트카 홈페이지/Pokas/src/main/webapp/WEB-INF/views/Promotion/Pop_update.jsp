...
<!-- <section id="side-wrap">
    ...
    <section id="table">
    <form action ="/Promotion/Promotion_updateProc" enctype="multipart/form-data" method="post" accept-charset="UTF-8">
        <div class="cont">
        <input type="hidden" value="${view.id}" name="id">
            <table>
               <tbody>
                     ...
                     <tr>
                        <td class="name">이름</td>
                           <td class="table_cont cont_04" colspan="3">
                                ...
                                <input class="write-input" type='text' value="${view.name}" name='name' style="margin-left: 0px;"/>
                            
                        </td>
                    </tr>
                     <tr>
                        <td class="name">시작일시</td><td class="table_cont cont_04">
                            
                                <input class="write-input" type='datetime' value="${view.start_ddt}" name='start_ddt'/>
                            
                        </td>
                        <td class="name">종료일시</td><td class="table_cont cont_04">
                            
                                <input class="write-input" type='text' value="${view.end_ddt}" name='end_ddt'/>
                            
                        </td>
                    </tr>
                     <tr>
                        <td class="name">상품유형</td><td class="table_cont cont_04">
                            
                                <input class="write-input" type='text' value="${view.product_type}" name='product_type'/>
                               <br> (장기렌트 : 1, 오토리스 : 2)
                            
                        </td>
                        <td class="name">등급</td><td class="table_cont cont_04">
                     ...
                     <tr>
                        <td class="name">연료</td><td class="table_cont cont_04">
                            
                                <input class="write-input" type='text' value="${view.oil_type}" name='oil_type'/>
                            
                        </td>
                        <td class="name">배기량</td><td class="table_cont cont_04">
                            
                                <input class="write-input" type='text' value="${view.cc}" name='cc'/>
                            
                        </td>
                    </tr>

                    <tr>
                        <td class="name">연비</td><td class="table_cont cont_04">
                            
                                <input class="write-input" type='text' value="${view.oil_rate}" name='oil_rate'/>
                            
                        </td>
                        <td class="name">약정거리</td><td class="table_cont cont_05">
                            
                                <input class="write-input" type='text' value="${view.agreement_dist}" name='agreement_dist' />
                            
                        </td>
                    </tr>

                    <tr>
                        <td class="name">개런티</td><td class="table_cont cont_05">
                            
                                <input class="write-input" type='text' value="${view.guarantee}"  name='guarantee' />
                            
                        </td>
                        <td class="name">옵션</td><td class="table_cont cont_05">
                            
                                <input class="write-input" type='text' value="${view.option}" name='option' />
                            
                        </td>
                    </tr>

                    <tr>
                        <td class="name">개월</td><td class="table_cont cont_05" colspan="3">
                            
                                <input class="write-input" type='text' value="${view.months}" name='months' />
                            
                        </td>
                    </tr>
                    <tr>
                        <td class="name">원</td><td class="table_cont cont_05" colspan="3">
                            
                                <input class="write-input" type='text' value="${view.price}" name='price' />
            ...
            <button><a href=""><h2 class="a">업로드하기</h2></a></button>
