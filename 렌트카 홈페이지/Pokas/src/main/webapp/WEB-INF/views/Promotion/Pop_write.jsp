...
<!-- <section id="side-wrap">
    ...
    <section id="table">
    <form action ="/Promotion/Promotion_write" enctype="multipart/form-data" method="post" accept-charset="UTF-8">
        <div class="cont">
            <table>
               <tbody>
                     ...
                     <tr>
                        <td class="name">시작일시</td><td class="table_cont cont_04">
                                ...
                                <input class="write-input" type='date' name='start_ddt'/>
                            
                        </td>
                        <td class="name">종료일시</td><td class="table_cont cont_04">
                            
                                <input class="write-input" type='date' name='end_ddt'/>
                     ...
                     <tr>
                        ...
                        <td class="name">배기량</td><td class="table_cont cont_04">
                                ...
                                <input class="write-input" type='number' name='cc'/>
                    ...
                    <tr>
                        ...
                        <td class="name">약정거리</td><td class="table_cont cont_05">
                                ...
                                <input class="write-input" type='number' name='agreement_dist' />
                    ...
                    <tr>
                        <td class="name">개월</td><td class="table_cont cont_05" colspan="3">
                                ...
                                <input class="write-input" type='number' name='months' />
                    ...
                    <tr>
                        <td class="name">원</td><td class="table_cont cont_05" colspan="3">
                                ...
                                <input class="write-input" type='number' name='price' />
