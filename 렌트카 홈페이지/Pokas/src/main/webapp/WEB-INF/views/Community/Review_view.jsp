...
<head>
    ...
    <title>작성후기</title>
    <link rel="stylesheet" href="../../resources/css/review_custcar.css">
    ...
    $(function() {
		...
		$("#update_btn").click(function() {
			...
			window.location.href="/Community/Review_update?r_no="+viewid;
		})
...
<section id="side-wrap">
	...
	<script>
		...
		function scrollFunction() {
			if(document.body.scrollTop > 500 || document.documentElement.scrollTop > 500){
				...
				document.getElementById('side-wrap').style.top = '500px';
			}
		}
	</script>
 ...
 <header id="header">
	...
	<input id ="viewid" type="hidden" value="${view.id}">
    

    <section id="review_cust">
        <div class="cont">
            <div class="title">
                <h2>[제목] <c:out value="${view.title}"/></h2>
                <p><c:out value="${view.writer}"/> | <c:out value="${view.date}"/></p>
            </div>
			...
			<c:out value="${view.text}" escapeXml="false"/>		
...
<!--수정버튼-->
		<c:choose>
            ...
            <div class="fix_button">
            	...
            	<button id="update_btn" class="write"><a href="#none" class="a">글쓰기 수정</a></button>
            </div>
		</c:when>
		<c:otherwise>
            ...
            <button><a href="/Community/Review?cpage=1" class="a">목록</a></button>
        </div>
    </section>
    ...
    <section id="review">
		<div class="cont">
			<div class="review">
			<c:forEach var="review" items="${list}" begin="0" end="3">
				<div class="box">
					<div class="img" onclick="location.href='/Community/Review_view?r_no=${review.id}'">
						<img src="/resources/img/${review.image}" alt="review_car">
					</div>
					<div class="cont_part">
						<h2><c:out value="${review.title}"/></h2>
						<c:out value="${review.image}"/>
    ...
    <form id="MsgForm" name="MsgForm" method="POST" action="/Sms" onSubmit="return varcheck();">
     	<input type="hidden" name="strData" value="test">
        ...
        <div class="cont">
                    ...
                    <tr>
                     ...
                     <tr>
                        <td class="name">휴대폰 <br/> <span>*필수</span></td><td class="table_cont cont_04">
                                ...
                                <input type='tel' name='phone' id="phone1" maxlength='3' required/> -
			...
			<div class="button">
            	<button type="submit"id="submitbtn" style="margin:0"><h2 class="a">견적요청하기</h2></button>
			</div>
        </div>
	</form>
    </section>
