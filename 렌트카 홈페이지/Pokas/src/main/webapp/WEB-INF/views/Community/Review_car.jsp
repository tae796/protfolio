...
<head>
    ...
    <script src="../../resources/js/review_car.js"></script>
    ...
    <section id="review">
        <div class="cont">
            <div class="title">
             ...
             <div class="review">
             <c:forEach var="review_car" items="${list}" begin="0" end="7"> 
           
               <div class="box" style=" cursor: pointer;" onclick="location.href='Review_view?r_no=${review_car.id}#target';">
		            <div class="img">
		            <img src="/resources/img/${review_car.image}" style="width: 100%;"></img>
		            </div>
		            <h2><c:out value="${review_car.title}"/></h2>
		...
		<div class="write_button">
            	<button class="write">관리자 글쓰기</button>
            </div>
		</c:when>
		<c:otherwise>
