 ...
 <header id="header">
	...
	<section class="searchbox">
		...
		<ul>
			...
			<li class="searchbox-list">
				<button id="car_search" class="search-btn">차량검색</button>
			</li>
		</ul>
	</section>
    ...
    <section id="review">
        <div class="cont">
            ...
            <div class="review">
            <c:forEach var="info" items="${list}" begin="0" end="7">        
                <div class="box" onclick="location.href='Review_view?r_no=${info.id}';">
                    <div class="img">
                    <img src="/resources/img/${info.image}" style="width: 100%; height: 100%;"></img>
                    </div>
