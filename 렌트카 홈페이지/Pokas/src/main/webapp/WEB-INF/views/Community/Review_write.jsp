...
<c:choose>
    ...
    <form id="frm" action ="/Community/Review_writeProc" enctype="multipart/form-data" method="post" accept-charset="UTF-8" name="signup">
        <div class="cont">
			<table>
				<tbody>
					...
					<tr>
						...
						<td class="table_cont cont_04">
							<select  class="write-input" name='type' style="margin-left: 0px;">
								...
								<option value="1">계약서 작성후기</option>
								<option value="2">차량 출고 후기</option>
								<option value="3">장기렌트 & 리스 정보</option>
								<!-- <input class="write-input" type='text' name='type' style="margin-left: 0px;" />
					...
					<tr>
						...
						<td class="table_cont cont_04">
							...
							<input class="write-input" type='text' name='title' id="title" />
					...
					<tr>
						...
						<td class="table_cont cont_04">
							...
							<input class="write-input" type='text' name='writer' />
					...
					<tr>
						<td class="name">내용</td>
						<td class="table_cont cont_04">
							<textarea class="from-control" id="smarteditor" rows="20" name="text" ></textarea>
						</td>
					</tr>
