  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    ...
    $(function() {
	    ...
	    $("#writebtn").click(function() {
			window.location.href="/Community/Review_write";
...
<c:choose>
      <c:when test="${not empty mdto.center}">
            ...
            <div class="col-md-12">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb has-gap breadcrumb-arrow pl-0">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">후기목록</li>
                </ol>
              </nav>
            </div>
            ...
            <div class="ms-panel-body">
              <div class="table-responsive">
                <table class="table table-hover thead-primary">
                  ...
                  <tbody>
                <c:forEach var="i" items="${r_list1}">
                  <input type="hidden" value="${i.id}">
                    <tr>
                      <th scope="row" id="f_no${i.id}">${i.id}</th>
                      <td class="text-center">차량 후기</td>
                      <td class="text-center">${i.title}</td>
                      <td class="text-center">${i.writer}</td>
                      <td class="text-center">${i.center}</td>
                      <td class="text-center">${i.team}</td>
                      <td>
                      <input type="button" onclick="location.href='/Community/Review_update?r_no=${i.id}';" class="btn btn-success btn-sm my-0 updatebtn" value="수정">
                ...
                <c:forEach var="i" items="${r_list2}">
                  <input type="hidden" value="${i.id}">
                    <tr>
                      <th scope="row" id="f_no${i.id}">${i.id}</th>
                      <td class="text-center">계약서 작성 후기</td>
                      <td class="text-center" onclick="location.href='/Community/Review_view?r_no=${i.id}';" >${i.title}</td>
                      <td class="text-center">${i.writer}</td>
                      <td class="text-center">${i.center}</td>
                      <td class="text-center">${i.team}</td>
                      <td>
