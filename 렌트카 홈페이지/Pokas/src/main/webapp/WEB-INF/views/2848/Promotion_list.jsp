  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    ...
    $(function() {
	    ...
	    $("#writebtn").click(function() {
			window.location.href="/Promotion/Pop_write";
            ...
            <div class="col-md-12">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb has-gap breadcrumb-arrow pl-0">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">프로모션목록</li>
                </ol>
              </nav>
            </div>
                ...
                <c:forEach var="i" items="${p_list}">
                  <input type="hidden" value="${i.id}">
                    <tr>
                      ...
                      <td>
                      <input type="button" onclick="location.href='/Promotion/Promotion_update?id=${i.id}';" class="btn btn-success btn-sm my-0 updatebtn" value="수정">
