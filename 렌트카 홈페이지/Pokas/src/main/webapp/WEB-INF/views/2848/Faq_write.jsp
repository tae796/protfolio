...
<!-- <section id="side-wrap">
    ...
    <form action ="/2848/Faq_insertproc" enctype="multipart/form-data" method="post" accept-charset="UTF-8">
        <div class="cont">
			<table>
				<tbody>
					...
					<tr>
						...
						<td class="table_cont cont_04">
							...
							<input class="write-input" type='text' name='title' />
