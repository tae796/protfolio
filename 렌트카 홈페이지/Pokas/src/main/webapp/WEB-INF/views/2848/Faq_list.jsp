...
<head>
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    ...
    $(function() {
		...
		window.location.href="/2848/Faq_write";
            ...
            <div class="col-md-12">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb has-gap breadcrumb-arrow pl-0">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">자주묻는질문목록</li>
                </ol>
              </nav>
            </div>
              ...
              <div class="table-responsive">
                ...
                <c:forEach var="i" items="${f_list}">
                  <input type="hidden" value="${i.id}">
                    <tr>
                      <th class="text-center" scope="row" id="f_no${i.id}">${i.id}</th>
                      <td class="text-center">${i.title}</td>
                      <td>
                      <input type="button" onclick="location.href='/2848/Faq_update?id=${i.id}';" class="btn btn-success btn-sm my-0 updatebtn" value="수정">
