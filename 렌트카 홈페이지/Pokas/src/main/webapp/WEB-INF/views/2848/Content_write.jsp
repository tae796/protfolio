            ...
            <div class="col-md-12">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb has-gap breadcrumb-arrow pl-0">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">게시글작성</li>
                </ol>
              </nav>
            </div>
            ...
            <div class="ms-panel-body">
              <div class="table-responsive">
                <table class="table table-hover thead-primary">
                  ...
                  <tbody>
                   <tr>
                      <td class="text-center"><a href="/Community/Review_write">커뮤니티 업로드</a></td>
                      <td class="text-center"><a href="/Search/Car_write">차량검색 차량업로드</a></td>
                      <td class="text-center"><a href="/Promotion/Hot_write">프로모션 핫딜 업로드</a></td>
                      <td class="text-center"><a href="/Promotion/Pop_write">프로모션 인기차종 업로드</a></td>
...
<a href="/2848/login">관리자 로그인하러가기</a>
    ...
    $(document).ready(function(){
    	...
    	$("#deletembtn").click(function() {
    		e.preventDefault();
    		$.ajax({
    			url : "/magazine/m_delete",
    			type : "post",
    			dataType : "json",
    			data : {
    				"id" : $("#deletembox").val()
