...
public class HotdealDTO {
	...
	public HotdealDTO(int id, int product_type, String name, String grade,String oil_type,int cc,String oil_rate,int agreement_dist,String guarantee,String option,int months, int price, Date start_ddt, Date end_ddt, String image) {
		super();
		this.id = id;
